...
namespace RezerwacjaBiletow.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            return View(await _context.Rezervation.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var reservation = await _context.Rezervation
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var reservation = await _context.Rezervation.SingleOrDefaultAsync(m => m.ID == id);
            if (reservation == null)
            {
                return NotFound();
            }
        ...
        {
            var reservation = await _context.Rezervation.SingleOrDefaultAsync(m => m.ID == id);
            _context.Rezervation.Remove(reservation);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
